abstract module PQ {
  ...
  class PriorityQueue {
    ...
    /* Lemma: proves that after swaping the value between j and his father (j-1)/2 in the float process, the heap property (excepting the father with its ancestors) */
